<template>
    ...
    <div class="animated fadeIn">
        ...
        <!--  -->
        <el-dialog :title="'风险'+taskInfo.taskName" :visible.sync="dialogFormVisible"  width="30%">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button type="primary" @click="submitData(true)">同意</el-button>
                <el-button type="danger" @click="submitData(false)">驳回</el-button>
...
export default {
  ...
  methods: {
    ...
    submitData (auditResult, auditType) {
  ...
  created () {
    ...
    if (this.taskInfo.taskName.includes('一')) {
      this.active = 5
      this.auditType = 3
    } else if (this.taskInfo.taskName.includes('二')) {
      this.active = 6
      this.auditType = 4
    } else if (this.taskInfo.taskName.includes('三')) {
      this.active = 7
      this.auditType = 5
    }
